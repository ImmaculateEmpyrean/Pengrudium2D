...
namespace penguin2D
{
	...
	public:
		...
		///this function returns an object which can be used to log to the stdout.. the signature is editor..
		///@warning the signature editor states that editor is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature editor.  
		///@see getConsoleLoggerEngine() getConsoleLoggerExecutable() getConsoleLoggerTest() getConsoleLoggerExample()
		static consoleLog getConsoleLoggerEditor();

		///this function returns an object which can be used to log to the stdout.. the signature is executable..
		///@warning the signature executable states that executable is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature executable.  
		///@see getConsoleLoggerEngine() getConsoleLoggerEditor() getConsoleLoggerTest() getConsoleLoggerExample()
		static consoleLog getConsoleLoggerExecutable();

		///this function returns an object which can be used to log to the stdout.. the signature is test..
		///@warning the signature test states that test is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature test.  
		///@see getConsoleLoggerEngine() getConsoleLoggerEditor() getConsoleLoggerExecutable() getConsoleLoggerExample() 
		static consoleLog getConsoleLoggerTest();

		///this function returns an object which can be used to log to the stdout.. the signature is example..
		///@warning the signature example states that example is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature example.  
		///@see getConsoleLoggerEngine() getConsoleLoggerEditor() getConsoleLoggerExecutable() getConsoleLoggerTest() 
		...
		///this function returns an object which can be used to log to relevant files.. the signature is editor..
		///@warning the signature editor states that editor is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature editor.  
		///@see getFileLoggerEngine() getFileLoggerExecutable() getFileLoggerTest() getFileLoggerExample()
		static fileLog getFileLoggerEditor();

		///this function returns an object which can be used to log to relevant files.. the signature is executable..
		///@warning the signature executable states that executable is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature executable.  
		///@see getFileLoggerEngine() getFileLoggerEditor() getFileLoggerTest() getFileLoggerExample()
		static fileLog getFileLoggerExecutable();

		///this function returns an object which can be used to log to relevant files.. the signature is test..
		///@warning the signature test states that test is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature test.  
		///@see getFileLoggerEngine() getFileLoggerEditor() getFileLoggerExecutable() getFileLoggerExample()
		static fileLog getFileLoggerTest();

		///this function returns an object which can be used to log to relevant files.. the signature is example..
		///@warning the signature example states that example is the one logging no matter who logs using the object provided by this function..
		///@returns an object which can be used to safely log to stdout in a multi-threaded environment with the signature example.  
		///@see getFileLoggerEngine() getFileLoggerEditor() getFileLoggerExecutable() getFileLoggerTest()
